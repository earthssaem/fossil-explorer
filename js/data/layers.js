...
const DEFAULT_LAYER_DATA = [
  ...
  { id: "D", label: "지층 D", era: "중생대 말~신생대 초", env: "바다", isBoundary: true,
    ...
    hiddenInfo: "아래층에는 암모나이트가 풍부하지만, 얇고 검은 경계층 바로 위에서는 화석이 거의 나오지 않습니다. 경계층을 전후하여 발견되는 대표 화석의 종류가 크게 달라지며, 이렇게 화석의 종류가 크게 달라지는 곳이 지질 시대의 경계가 됩니다. 이리듐이 많은 점토층과 충격을 받은 석영은 당시 거대한 소행성 충돌이 있었음을 보여 주는 중요한 증거로 해석됩니다.",
    bands: [
