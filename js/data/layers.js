...
const DEFAULT_LAYER_DATA = [
  ...
  { id: "C", label: "지층 C", era: "중생대", env: "육지", color1: "#b0805a", color2: "#946746",
    hiddenName: "중생대의 육지",
    hiddenInfo: "공룡과 고사리가 함께 발견되는 지층입니다. 공룡은 시대를, 고사리는 습한 육지라는 환경을 알려줍니다." },
  { id: "D", label: "지층 D", era: "중생대 말~신생대 초", env: "바다", isBoundary: true,
    ...
    hiddenInfo: "아래층에는 암모나이트가 풍부하지만, 얇고 검은 경계층 위에서는 화석이 거의 나오지 않습니다. 경계층을 전후하여 발견되는 대표 화석의 종류가 크게 달라집니다. 이렇게 화석의 종류가 크게 달라지는 곳이 지질 시대의 경계가 됩니다.",
    bands: [
  ...
  { id: "E", label: "지층 E", era: "신생대", env: "바다", color1: "#7c5c40", color2: "#644830",
    hiddenName: "신생대의 바다",
    hiddenInfo: "경계층 위쪽에서 쌓인 지층으로, 화폐석이 발견됩니다. 경계층 아래에서 발견된 대표 화석과 다른 화석이 발견됩니다." },
    ...
    stage2: {
      ...
      layers: [
        ...
        { n: 4, fossils: [], band: true, answer: "boundary", key: ["order", "band"],
          explain: "아래층에서는 중생대의 공룡이, 위층에서는 신생대의 화폐석이 나온다. 이 검은 띠는 그 사이에 놓인 중생대 말~신생대 초 경계층이다.",
          explainBand: "검은 띠의 모습뿐 아니라 그 아래와 위에서 나타나는 화석의 변화도 우리 공원의 경계층과 비슷하다. 검은 띠의 색만으로 같은 층이라고 판단하지는 않는다." },
        ...
        { n: 6, fossils: ["mammoth"], answer: "F", key: ["mammoth"],
          explain: "매머드는 신생대 후기에 살았던 대표적인 포유류 화석이다. 두껍고 긴 털은 이 시기에 추운 기후가 있었음을 알려준다." }
      ],
      closing: {
        ...
        explanation: "같은 시대에도 어떤 지역은 바다이고 다른 지역은 육지일 수 있다. 따라서 서로 떨어진 지층을 비교할 때는 환경만으로 판단하지 않고 표준 화석 등을 이용해 시대를 함께 비교한다. 이처럼 서로 떨어진 지층의 시대를 비교하여 연결하는 것을 지층 대비라고 한다.",
...
const DEFAULT_NOTE_DATA = [
  ...
  { title: "표준 화석", body: "지층의 시대를 알려주는 화석. 생존 기간이 짧고, 넓은 지역에 많이 분포할수록 좋다. (삼엽충·암모나이트·공룡·화폐석)" },
