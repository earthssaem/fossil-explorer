...
const DEFAULT_WORLD_DATA = {
  ...
  fixed: [
    ...
    { key: "sign", col: 44, row: 33, id: "s_track",
      text: ["발자국 광장", "옛 육지에 남은 발자국 화석입니다. 어떤 생물이 언제 남긴 것인지 노두의 화석으로 추리해 보세요.", "발자국은 몸체 화석이 아니라 흔적 화석입니다."] },
    { key: "sign", col: 27, row: 26, id: "s_gorge",
      text: ["검은 띠 협곡", "골짜기 양쪽 절벽에 얇고 검은 띠가 이어집니다. 같은 층은 멀리 떨어진 곳에서도 이어져 있습니다.", "이 띠의 아래와 위에서 나오는 화석을 비교해 보세요. 무엇이 달라졌는지가 중요한 단서입니다."] },
