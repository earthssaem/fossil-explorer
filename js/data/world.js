/* ==========================================================================
   ...
   · 강이 남북으로 흐르며 골짜기를 팠다. 강물이 깎아 만든 절벽이 노두이며,
...
const DEFAULT_WORLD_DATA = {
  ...
  fixed: [
    ...
    { key: "sign", col: 23, row: 61, id: "s_start",
      text: ["지질공원 안내", "이 탐사로에서는 남쪽에서 북쪽으로 이동할수록 더 젊은 지층을 차례로 만날 수 있습니다.", "강가의 노두 6곳을 조사하고, 북쪽 전망대에서 기록을 하나로 이어 보세요."] },
    ...
    { key: "sign", col: 27, row: 26, id: "s_gorge",
      text: ["경계층 협곡", "골짜기 양쪽 절벽에 얇고 검은 띠가 이어집니다. 같은 층은 멀리 떨어진 곳에서도 이어져 있습니다.", "이 띠 아래에는 암모나이트가 풍부하지만, 위에서는 전혀 다른 화석이 나옵니다. 그래서 여기가 중생대와 신생대의 경계입니다."] },
    { key: "sign", col: 13, row: 12, id: "s_lake",
      text: ["신생대 호수", "이 구역의 지층은 신생대 바다에서 쌓였습니다.", "그 뒤 땅이 융기하여 지금은 육지가 되었고, 여기에 호수가 생겨 갈대가 자랍니다."] }
  ],
  clusters: [
  ...
  npcs: [
    { id: "ranger", key: "ranger", col: 22, row: 60, name: "해설사",
      lines: [
        "어서 오세요, 탐사대원! 이 공원은 북쪽으로 갈수록 지대가 높아지고, 지층은 아래에서 위로 쌓이므로 북쪽으로 갈수록 더 젊은 지층 위를 걷게 됩니다.",
        "강물이 깎아 만든 절벽이 노두입니다. 노두마다 그 구역의 지층과 아래층 윗부분이 드러나니, 6곳을 이어 붙여 보세요.",
        "구역 사이 계단은 앞 구역의 노두를 다 조사해야 열립니다. 변화를 시간 순서대로 보기 위한 규칙이에요.",
        "노두 6곳을 모두 조사하면 북쪽 전망대에서 흩어진 기록을 하나로 잇는 최종 미션이 기다립니다."
      ],
      again: ["노두마다 보이는 조각을 이어 붙이면 이 공원 전체의 층서가 완성됩니다. 북쪽 전망대에서 만나요!"] }
  ],
  start: { col: 20, row: 62 }
};
